...
const displaySeeds: Seed[] = [
  ...
  { name: "Oak", slug: "oak", manufacturer: "Clayton TRU", series: "TRU Origin", modelNumber: "Oak", bedrooms: 3, bathrooms: 2, squareFeet: 1001, width: 28, length: 56, size: "28' x 56'", startingPrice: 84608.94, priceLabel: "Starting Price", isFeatured: true, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: false },
...
const knownLineupSeeds: Seed[] = [
  { name: "Maple", slug: "maple", manufacturer: "Clayton TRU", series: "TRU Origin", modelNumber: "Maple", bedrooms: 3, bathrooms: 2, squareFeet: 1264, width: 28, length: 48, size: "28' x 48'", startingPrice: null, priceLabel: "Call/Text for starting price", isFeatured: false, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: true },
  { name: "White Oak", slug: "white-oak", manufacturer: "Timber Creek Housing", series: "Creekside Series", modelNumber: "CS-3221", bedrooms: 3, bathrooms: 2, squareFeet: 2280, width: 30, length: 76, size: "30' x 76'", startingPrice: null, priceLabel: "Call/Text for starting price", isFeatured: false, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: true },
  { name: "Boujee 2", slug: "boujee-2", manufacturer: "Clayton Addison", series: "Boujee Series", modelNumber: "44BOU28603BH", bedrooms: 3, bathrooms: 2, squareFeet: 1580, width: 28, length: 60, size: "28' x 60'", startingPrice: null, priceLabel: "Call/Text for starting price", isFeatured: false, isOnDisplay: false, isCatalogModel: true, isSpecialOffer: false, isNewArrival: true },
  { name: "Delilah", slug: "delilah", manufacturer: "Timber Creek Housing", series: "Creekside Series", modelNumber: "CSFL-3301", bedrooms: 4, bathrooms: 2, squareFeet: 2280, width: 30, length: 76, size: "30' x 76'", startingPrice: null, priceLabel: "Call/Text for starting price", isFeatured: false, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: true },
