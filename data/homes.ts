...
const knownLineupSeeds: Seed[] = [
  { name: "Maple", slug: "maple", manufacturer: "Clayton TRU", series: "TRU Origin", modelNumber: "Maple", bedrooms: 3, bathrooms: 2, squareFeet: 1264, width: 28, length: 48, size: "28' x 48'", startingPrice: 98000, priceLabel: "Starting Price", isFeatured: false, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: true },
