...
const displaySeeds: Seed[] = [
  ...
  { name: "Craft Select 28603A", slug: "craft-select-28603a", manufacturer: "Cavco Plant City", series: "Craft Select", modelNumber: "Craft Select 28603A", bedrooms: 3, bathrooms: 2, squareFeet: 1680, width: 26.67, length: 60, size: "26' 8\" x 60'", startingPrice: 126049.75, priceLabel: "Starting Price", isFeatured: true, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: false },
...
const protectedSeedPriceSlugs = new Set(["tulip", "paxton"]);
