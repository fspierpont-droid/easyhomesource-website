...
const displaySeeds: Seed[] = [
  ...
  { name: "Boujee XL 2", slug: "boujee-xl-2", manufacturer: "Clayton Addison", series: "Boujee Series", modelNumber: "Boujee XL 2", bedrooms: 4, bathrooms: 3, squareFeet: 1832, width: 28, length: 72, size: "28' x 72'", startingPrice: 147374.32, priceLabel: "Starting Price", isFeatured: true, isOnDisplay: true, isCatalogModel: false, isSpecialOffer: false, isNewArrival: false, note: "Standard layout is 4 bedrooms and 3 bathrooms; a 5-bedroom option is available. Confirm the selected option, final square footage, and pricing on the factory order before quoting." }
];
