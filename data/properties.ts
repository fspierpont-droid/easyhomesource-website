...
export const properties: PropertyRecord[] = [
  {
    ...
    propertyType: "Land & Home Package",
    units: 1,
    price: 189900,
    salesRep: "Scott Pierpont",
    notes: "Citrus County PIN # 1504635 • 1,291 sq ft base living area • 2 utility buildings, 2 carports, screened porches & patio slab",
    source: "Citrus County Property Appraiser (CCPA)",
  ...
  },
  {
    ...
    units: 1,
    price: 29900,
    salesRep: "Alex Vorasane",
    notes: "Highland Lakes Replat Block T Lot 26 (ORB 541 PG 37) • Parcel Key # 00086392 • 5,500 sq ft",
    source: "Hernando County Property Appraiser (HCPA)",
    updatedAt: "2026-08-10",
    displayOrder: 7,
    publicVisible: true
  },
  ...
  },
  {
    ...
    price: 198500,
    salesRep: "Alex Vorasane",
    notes: "Pasco County Parcel # 02-26-19-0030-00000-7850 • Fireplace feature (1983) • Warranty Deed 11424/1342",
    source: "Pasco County Property Appraiser (Mike Wells PA)",
    updatedAt: "2026-08-10",
    displayOrder: 12,
    publicVisible: true
  },
