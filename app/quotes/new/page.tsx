...
export default function NewQuoteBuilderPage() {
  ...
  const [selectedHome, setSelectedHome] = useState<MasterCatalogHome | null>(null);
  const [basePrice, setBasePrice] = useState<number>(0);
  const [factoryCost, setFactoryCost] = useState<number>(0);

  // 3. Site & Delivery (NO SETBACKS)
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="bg-white border-b border-slate-200 px-6 py-4 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className="text-2xl font-black text-[#0B1E38] tracking-tight">
                {customerName.trim() ? customerName : 'Build a polished customer quote'}
              </h1>
              {selectedHome && (
          ...
          <div className="p-6 sm:p-8 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-[220px_1fr_340px] gap-6 items-start">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-6">
              ...
              {currentStep === 6 && (
                <div className="space-y-4 text-xs">
                  <h3 className="text-base font-black text-[#0B1E38]">Review &amp; Generate Proposal</h3>
