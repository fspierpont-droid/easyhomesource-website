...
export const metadata: Metadata = {
  ...
  description: 'Production operational hub and single source of truth for Easy HomeSource manufactured homes, quotes, land packages, inventory, projects, and permitting.'
};
