...
export const metadata: Metadata = {
  ...
  description: 'Production operational hub and single source of truth for Easy HomeSource manufactured homes, quoting, projects, land packages, inventory, and permitting.'
};
