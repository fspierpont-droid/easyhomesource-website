      ...
      <body>
        ...
        <footer className="bg-forest px-4 py-12 text-white">
          <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
            ...
            <div><p className="font-black">Location</p><address className="mt-3 not-italic text-white/75">9011 McIntyre Rd<br />Brooksville, FL 34601</address><Link className="mt-4 inline-flex rounded-full bg-clay px-5 py-3 font-black text-white hover:bg-clay/90" href="/contact">Request Info</Link></div>
          </div>
