    ...
    <main className="px-4 py-12">
      <div className="mx-auto max-w-6xl">
        <section className="rounded-[2rem] bg-ehsSoftBlue p-6 sm:p-10">
          ...
          <p className="mt-4 max-w-4xl text-lg leading-8 text-ehsBlack/75">Browse Easy HomeSource homes in Brooksville, compare starting prices and floor plans, then request current pricing, financing guidance, delivery and setup, permits, and final quote details.</p>
          ...
          <Link href="/homes/tulip" className="mt-6 block rounded-[2rem] border-2 border-ehsBlue bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg sm:p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 font-semibold leading-7 text-ehsBlack/70">2 beds • 1 bath • 544 sq. ft. Request final Easy HomeSource quote details for delivery and setup, taxes, fees, permits, site conditions, and financing guidance.</p>
              </div>
