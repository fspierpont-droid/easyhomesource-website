      ...
      <div className="mx-auto max-w-6xl">
        <section>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <h1 className="text-4xl font-black text-ehsBlack sm:text-5xl">{home.name}</h1>
          ...
          <section id="lead-form" className="mt-10 scroll-mt-28 rounded-[2rem] border border-borderGray bg-white p-5 shadow-sm sm:p-8"><div className="mb-6 max-w-3xl"><p className="text-sm font-black uppercase tracking-wide text-ehsBlue">Request pricing</p><h2 className="mt-2 text-3xl font-black text-ehsBlack">Get a quote on {home.name}</h2><p className="mt-3 leading-7 text-ehsBlack/70">Submit the form below and the Brooksville team can follow up on availability, financing options, delivery, setup, and permitting.</p></div><LeadForm interestedHome={home.name} interestedHomeSlug={home.slug} cta="Get Pricing" sourcePage={`${home.name} home detail`} /></section>
