...
export default function HomeDetailPage({ params }: { params: { slug: string } }) {
  ...
  const quoteHref = `/get-quote?home=${encodeURIComponent(home.slug)}&source=home-detail`;
      ...
      <div className="mx-auto max-w-6xl">
        <section>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end"><ButtonLink href={`${quoteHref}&cta=get-pricing`}>Get Pricing</ButtonLink><ButtonLink href="tel:+13525588888" variant="secondary">Call/Text</ButtonLink></div>
          </div>
