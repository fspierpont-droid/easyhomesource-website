...
export default function VideosPage() {
  return <main className="px-4 py-12"><section className="mx-auto max-w-6xl">
    <div className="rounded-[2rem] bg-ehsSoftBlue p-6 sm:p-10"><p className="font-black text-ehsBlue">Videos & Walkthroughs</p><h1 className="mt-2 text-4xl font-black text-ehsBlack sm:text-5xl">See homes before you visit</h1><p className="mt-4 max-w-3xl text-lg leading-8 text-ehsBlack/75">Watch quick walkthroughs, lot videos, and featured home previews before scheduling a tour.</p><div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap"><ButtonLink href="/get-quote?source=videos&cta=schedule-tour">Schedule a Tour</ButtonLink><ButtonLink href="/homes" variant="secondary">View Available Homes</ButtonLink><ButtonLink href="/get-quote" variant="secondary">Get Pricing</ButtonLink></div></div>
