  ...
  return (
    <main className="px-4 py-12">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1fr]">
        <section>
          <p className="font-black text-ehsBlue">Contact</p>
          <h1 className="mt-2 text-4xl font-black text-ehsBlack">Ready to talk about your next manufactured home?</h1>
          <p className="mt-4 text-lg leading-8 text-ehsBlack/75">Send a message and the Easy HomeSource team will follow up about available homes, pricing, financing guidance, delivery, setup, permitting, and Brooksville-area next steps.</p>
