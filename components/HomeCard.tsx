  ...
  return (
    <article className="group overflow-hidden rounded-[1.75rem] border border-borderGray bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="space-y-5 p-5 sm:p-6">
        ...
        <div className="rounded-2xl bg-ehsSoftBlue/70 p-4"><p className="text-xs font-black uppercase tracking-wide text-ehsBlack/60">Starting price</p><p className="mt-1 text-3xl font-black text-ehsBlack">{home.price ?? "Call for current pricing"}</p></div>
