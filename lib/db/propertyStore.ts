...
export const INITIAL_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    propertyType: "LAND",
    builder: null,
    community: "Highland Lakes Replat",
    price: 29900,
    bedrooms: null,
    bathrooms: null,
    squareFeet: null,
    lotSize: "5,500 sq ft (0.13 acres)",
    parcelNumber: "00086392",
    photos: [],
    description: "Highland Lakes Replat Block T Lot 26 (ORB 541 PG 37). Vacant residential parcel (DOR 00) with 5,500 sq. ft. in Hernando County. Sec 25-22-17, County Assessed Land Value $10,725, Impact Fee Value $8,700.",
    salesperson: "Alex Vorasane",
    publicVisible: true,
    featured: false,
    notes: "Highland Lakes Replat Block T Lot 26, Sec 25-22-17, Key # 00086392",
    internalNotes: "Official HCPA Record: Key # 00086392. DOR 00 Vacant Residential. Assessed Land: $10,725. Impact Fee Value: $8,700. Paved road frontage.",
    zoning: "R-1M (Vacant Residential 00)",
    floodZone: "Zone X",
    utilities: { water: "NEEDS_WELL", sewer: "NEEDS_SEPTIC", electric: "CONNECTED" },
    history: [],
    createdAt: "2026-08-03T10:00:00Z",
    updatedAt: "2026-08-10T17:15:00Z"
  },
  {
    id: "EHS-008",
